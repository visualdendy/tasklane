...
export default function BoardHeader({ board }: BoardHeaderProps) {
    ...
    const { addBoardMember, removeBoardMember, setCurrentBoard } = useBoardStore();
    ...
    return (
        <>
            <div className="h-16 px-4 flex items-center justify-between bg-white/10 backdrop-blur-md border-b border-white/10 text-white relative z-40">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            showActivity ? "bg-white/20 text-blue-400" : "hover:bg-white/10 text-white"
                        )}
                    >
                        <Activity size={18} />
                    ...
                    <div className="relative">
                        <button
                            ...
                            className={cn(
                                ...
                                showSettings ? "bg-white/20 text-white" : "hover:bg-white/10 text-white/70"
                            )}
                        >
                        ...
                        {showSettings && (
                            <div className="absolute top-10 right-0 z-[110]">
                                <BoardSettingsMenu
                                    boardId={board.id}
                                    boardName={board.name}
                                    onClose={() => setShowSettings(false)}
                                    onUpdate={(updatedBoard) => {
                                        setCurrentBoard({ ...board, ...updatedBoard });
